...
const Card = () => {
  const card = [
    ...
    { id: 5, title: "50 WC. Одноконтурный. Настенный", price: "Ваша выплата = 5000 р", img: "/public/5.png" },
    { id: 6, title: "30 AGB. Одноконтурный. Настенный", price: "Ваша выплата = 5000 р", img: "/public/6.png" },
    { id: 6, title: "35 WLB. Одноконтурный настенный", price: "Ваша выплата = 3000 р", img: "/public/6.png" },
    { id: 8, title: "30 AGB. Одноконтурный. Настенный", price: "Ваша выплата = 3000 р", img: "/public/6.png" },
    { id: 9, title: "26 WLB. Одноконтурный настенный", price: "Ваша выплата = 2500 р", img: "/public/6.png" },
  ];
